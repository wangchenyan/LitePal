...
import org.litepal.copy.tablemanager.callback.DatabaseListener
...
object LitePalCopy {
     ...
     * used with [LitePalCopy.limit], or nothing will return.
     *
    ...
    /**
     * Basically same as [LitePalCopy.saveAll] but pending to a new thread for executing.
     *
     * @param collection
     * Holds all models to save.
